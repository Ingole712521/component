    ...
    <div className="doc-stack">
              ...
              <div className="space-y-4">
                ...
                <p className="text-sm text-zinc-500">
                  ...
                  <code className="text-accent-secondary bg-accent/10 px-1.5 py-0.5 rounded ml-2">
                    lucide-react
                  </code>
                </p>
              </div>
                  ...
                  <table className="w-full text-sm">
                    ...
                    <tbody className="divide-y divide-white/5">
                      {[
                        ...
                        <tr key={row.prop}>
                          <td className="p-4 font-mono text-accent-secondary">
                            {row.prop}
                          </td>
                ...
                <div className="space-y-4">
                  <div className="p-4 rounded-xl border border-white/8 bg-white/2">
                    <h3 className="text-white font-medium mb-2">
                      <code className="text-accent-secondary">CardSlide</code>
                    </h3>
                  ...
                  <div className="p-4 rounded-xl border border-white/8 bg-white/2">
                    <h3 className="text-white font-medium mb-2">
                      <code className="text-accent-secondary">ImageSlide</code>
                    </h3>
                    <p className="text-sm text-zinc-500 mb-2">
                  ...
                  <div className="p-4 rounded-xl border border-white/8 bg-white/2">
                    <h3 className="text-white font-medium mb-2">
                      <code className="text-accent-secondary">CarouselSlide</code>
                    </h3>
                    <p className="text-sm text-zinc-500 mb-2">

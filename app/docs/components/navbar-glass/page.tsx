...
const sidebarItems = [
    ...
    { title: "Navigation", items: [{ name: "Floating Navbar", href: "/docs/components/navbar-floating" }, { name: "Glass Navbar", href: "/docs/components/navbar-glass", active: true }, { name: "", href: "/docs/components/" }] },
];

...
const sidebarItems = [
    ...
    { title: "Navigation", items: [{ name: "Floating Navbar", href: "/docs/components/navbar-floating", active: true }, { name: "Glass Navbar", href: "/docs/components/navbar-glass" }, { name: "", href: "/docs/components/" }] },
];
